...
DocMeta.setdocmeta!(RegularizedProblems, :DocTestSetup, :(using RegularizedProblems); recursive = true)
...
makedocs(;
    ...
    format = Documenter.HTML(; canonical = "https://JuliaSmoothOptimizers.github.io/RegularizedProblems.jl"),
